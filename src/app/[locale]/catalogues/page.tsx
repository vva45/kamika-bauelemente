...
export async function generateMetadata({ params }: PageProps<"/[locale]/catalogues">): Promise<Metadata> {
...
export default async function CataloguesPage({ params }: PageProps<"/[locale]/catalogues">) {
  const { locale } = await params;
  setRequestLocale(locale);
