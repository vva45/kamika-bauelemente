...
export const metadata: Metadata = {
  // Título fijo: en un fichero not-found no hay params de los que leer
  // el idioma A NIVEL DE MÓDULO. El cuerpo sí sale traducido — el
  // idioma lo fija el cazatodo en el mismo render.
  title: "404",
