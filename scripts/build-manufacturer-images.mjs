 ...
 * proveedor no se dibujan — usan el render real extraído de su PDF.
 * (El corte esquemático de perfil con cámaras que dibujaba este script
 * al principio se retiró en 2026-09: llevaba meses sin usarse, y
 * dibujar cámaras que nadie ha confirmado sería inventar specs.)
 */
const MAKERS = [
